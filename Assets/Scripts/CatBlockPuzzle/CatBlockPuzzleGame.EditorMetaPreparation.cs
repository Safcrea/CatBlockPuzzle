...
namespace CatBlockPuzzle
{
    public sealed partial class CatBlockPuzzleGame
    {
        ...
        private void PreparePersistentControls()
        {
            ...
            BindButton(settingsPanel.Find("Close").GetComponent<Button>(), ActionKind.CloseSettings);
            BindButton(settingsPanel.Find("Resume").GetComponent<Button>(), ActionKind.CloseSettings);
            BindToggle(soundToggle, ActionKind.Sound); BindToggle(hapticsToggle, ActionKind.Haptics); BindToggle(motionToggle, ActionKind.Motion);
