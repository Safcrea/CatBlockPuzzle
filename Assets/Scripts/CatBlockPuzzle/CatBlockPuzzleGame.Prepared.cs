...
namespace CatBlockPuzzle
{
    public sealed partial class CatBlockPuzzleGame
    {
...
#endif
        [SerializeField] private Image[] preparedEffects;
        [SerializeField] private Image backgroundCrossfade;
        ...
        public bool ValidatePreparedScene(out string error)
        {
            ...
            if (contentCatalog == null || contentCatalog.LevelCount != 100)
            ...
            else if (sceneCamera == null || sceneEventSystem == null || canvas == null ||
            ...
            else if (root == null || gameplayScreen == null || levelRoot == null || layoutProfile == null ||
                defaultFont == null || audioSource == null || buttonClip == null || snapClip == null || wrongClip == null || winClip == null)
                error = "required scene, layout, font, or audio references are missing";
            else if (winOverlay == null || failOverlay == null || settingsOverlay == null || metaOverlay == null ||
                metaHubPage == null || metaRoomPage == null || metaStoryOverlay == null || metaCompletionOverlay == null ||
                levelText == null || timerText == null || coinText == null || objectiveImage == null ||
                soundToggle == null || hapticsToggle == null || motionToggle == null ||
                previousTestButton == null || nextTestButton == null || metaNextLevelButton == null || metaDecorateNowButton == null)
                error = "required screen controls are missing";
                ...
                error = "the baked artwork is incomplete";
            if (error != null) return false;
            foreach (var sprite in catPortraitSprites) if (sprite == null) { error = "a cat portrait is missing"; return false; }
            foreach (var sprite in themeBackgroundSprites) if (sprite == null) { error = "a theme sprite is missing"; return false; }
